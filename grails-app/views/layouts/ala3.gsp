...
<head>
    ...
    <meta name="description" content="Sandbox | Atlas of Living Australia"/>
    ...
    <link rel="stylesheet" href="${resource(dir:'css',file:'jquery-ui-1.8.17.custom.css')}" type="text/css" media="screen"/>
    <link rel="stylesheet" type="text/css"  href="${resource(dir: 'css', file: 'main.css')}"/>
    <link rel="stylesheet" type="text/css"  href="${resource(dir: 'css', file: 'sandbox.css')}"/>
    ...
    <script language="JavaScript" type="text/javascript" src="${ConfigurationHolder.config.ala.baseURL}/wp-content/themes/ala2011/scripts/html5.js"></script>
