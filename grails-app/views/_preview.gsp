...
<div class="container-fluid" id="main">
    <div class="col-sm-12 col-md-12" ng-cloak>
        ...
        <div ng-show="preview.sandboxConfig.userId" class="pull-right">
            <a ui-sref="userDatasets({userId: preview.sandboxConfig.userId})" class="btn btn-default">My uploaded datasets</a>
        </div>

        <h1>${grailsApplication.config.skin.appName}<small ng-show="preview.existing.name"> Reloading {{preview.existing.name}} ({{ preview.existing.uid }})</small></h1>
                    ...
                    <div class="well">
                        <form class="form-inline">
                            ...
                            <button type="button" id="uploadButton" class="btn btn-primary"
                                    ng-click="preview.uploadToSandbox()" ng-bind="preview.uploadToSandboxLabel()">Upload your data</button>
                        </form>
