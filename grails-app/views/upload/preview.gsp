...
<head>
    ...
    <r:require modules="jasnybootstrap, progressbar, sandboxupload"/>
                ...
                <div id="processSampleUpload">
                  ...
                  <div class="well">
                    ...
                    <div class="progress" style="margin-top:20px;">
                        <div id="progressBar" class="progress-bar progress-bar-info" role="progressbar" data-transitiongoal="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
                        </div>
                    </div>
                    ...
                    <div id="optionsAfterDownload" style="display:none; margin-bottom: 0px; padding-bottom: 0px;">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                              <a href="#spatialPortalLink" id="spatialPortalLink" class="btn btn-default"
